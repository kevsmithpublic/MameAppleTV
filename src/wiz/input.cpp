...
static void updatekeyboard(void)
{
	...
	key[KEY_1]=( (ExKey1 & WIZ_MENU) && !(ExKey1 & WIZ_SELECT) && !(ExKey1 & WIZ_UP) && !(ExKey1 & WIZ_RIGHT) && !(ExKey1 & WIZ_DOWN) );
	/* Start B == Joystick UP + Start Button */
	key[KEY_2]=( ( (ExKey1 & WIZ_MENU) && !(ExKey1 & WIZ_SELECT) && (ExKey1 & WIZ_UP) && !(ExKey1 & WIZ_RIGHT) && !(ExKey1 & WIZ_DOWN) ) || (ExKey2 & WIZ_MENU));
	/* Start C == Joystick RIGHT + Start Button */
	key[KEY_3]=( ( (ExKey1 & WIZ_MENU) && !(ExKey1 & WIZ_SELECT) && !(ExKey1 & WIZ_UP) && (ExKey1 & WIZ_RIGHT) && !(ExKey1 & WIZ_DOWN) ) || (ExKey3 & WIZ_MENU));
	/* Start D == Joystick DOWN + Start Button */
	key[KEY_4]=( ( (ExKey1 & WIZ_MENU) && !(ExKey1 & WIZ_SELECT) && !(ExKey1 & WIZ_UP) && !(ExKey1 & WIZ_RIGHT) && (ExKey1 & WIZ_DOWN) ) || (ExKey4 & WIZ_MENU));
	/* Coin A == Select Button */
	key[KEY_5]=( !(ExKey1 & WIZ_MENU) && (ExKey1 & WIZ_SELECT) && !(ExKey1 & WIZ_UP) && !(ExKey1 & WIZ_RIGHT) && !(ExKey1 & WIZ_DOWN) );
	/* Coin B == Select Button + Joystick UP */	
	key[KEY_6]=( ( !(ExKey1 & WIZ_MENU) && (ExKey1 & WIZ_SELECT) && (ExKey1 & WIZ_UP) && !(ExKey1 & WIZ_RIGHT) && !(ExKey1 & WIZ_DOWN) ) || (ExKey2 & WIZ_SELECT));
	/* Coin C == Select Button + Joystick RIGHT */
	key[KEY_7]=( ( !(ExKey1 & WIZ_MENU) && (ExKey1 & WIZ_SELECT) && !(ExKey1 & WIZ_UP) && (ExKey1 & WIZ_RIGHT) && !(ExKey1 & WIZ_DOWN) ) || (ExKey3 & WIZ_SELECT));
	/* Coin D == Select Button + Joystick DOWN */
	key[KEY_8]=( ( !(ExKey1 & WIZ_MENU) && (ExKey1 & WIZ_SELECT) && !(ExKey1 & WIZ_UP) && !(ExKey1 & WIZ_RIGHT) && (ExKey1 & WIZ_DOWN) ) || (ExKey4 & WIZ_SELECT));

	key[KEY_TAB]=(ExKey1 & WIZ_MENU) && (ExKey1 & WIZ_SELECT);
	key[KEY_ENTER]=(ExKey1 & WIZ_B);
	key[KEY_ESC]=((ExKey1 & WIZ_L) && (ExKey1 & WIZ_R) && (ExKey1 & WIZ_MENU));
	key[KEY_P]=((ExKey1 & WIZ_L) && (ExKey1 & WIZ_R) && (!(ExKey1 & WIZ_MENU)));

    key[KEY_F11]=(((ExKey1 & WIZ_L) && (ExKey1 & WIZ_MENU)) || ((ExKey1 & WIZ_R) && (ExKey1 & WIZ_SELECT)));
    key[KEY_LSHIFT]=((ExKey1 & WIZ_L) && (ExKey1 & WIZ_MENU));
}
...
static int is_joy_button_pressed (int button, int ExKey)
{
	switch (button)
	{
		case 0: return ExKey & WIZ_B; break;
		case 1: return ExKey & WIZ_X; break;
		case 2: return ExKey & WIZ_A; break;
		case 3: return ExKey & WIZ_Y; break;
		case 4: return ExKey & WIZ_L; break;
		case 5: return ExKey & WIZ_R; break;
		default: break;
	}
	return 0; 
}
...
static int is_joy_axis_pressed (int axis, int dir, int ExKey)
{
	...
	if (!rotate_controls)
	{
		...
		if (axis==0)
		{
			switch (dir)
			{
				case 1: return ExKey & WIZ_LEFT; break;
				case 2: return ExKey & WIZ_RIGHT; break;
		...
		else
		{
			switch (dir)
			{
				case 1: return ExKey & WIZ_UP; break;
				case 2: return ExKey & WIZ_DOWN; break;
				default: return 0; break;
			}
		}
	}
	else
	{
		...
		else
		{
			switch (dir)
			{
				case 1: return ExKey & WIZ_RIGHT; break;
				case 2: return ExKey & WIZ_LEFT; break;
				default: return 0; break;
			}
		}
	}
...
int osd_is_joy_pressed(int joycode)
{
	...
	{
		case MOUSE_BUTTON(1):
			return ExKey1 & WIZ_B; break;
		case MOUSE_BUTTON(2):
			return ExKey1 & WIZ_X; break;
		case MOUSE_BUTTON(3):
			return ExKey1 & WIZ_A; break;
	}
...
{
	/*extern*/ int num_of_joys=0;

	switch (num_of_joys)
	{
		case 4: ExKey4=wiz_joystick_read(3);
		case 3: ExKey3=wiz_joystick_read(2);
		case 2: ExKey2=wiz_joystick_read(1);
		case 1: ExKey1=wiz_joystick_read(0); break;
		default:
			ExKey1=wiz_joystick_read(0);
			ExKey2=ExKey1;
			if(ExKey2&WIZ_MENU) ExKey2^=WIZ_MENU;
			if(ExKey2&WIZ_SELECT) ExKey2^=WIZ_SELECT;
			ExKey3=ExKey2;
			ExKey4=ExKey2;
			break;
	}
