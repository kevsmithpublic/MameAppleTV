...
int m4all_wiiDeadZoneValue = 1;//extern int iOS_wiiDeadZoneValue;//TODO
extern int m4all_inGame;
extern int m4all_waysStick;
#define STICK4WAY (m4all_waysStick == 4 && m4all_inGame)
#define STICK2WAY (m4all_waysStick == 2 && m4all_inGame)
...
int wiimote_send(struct wiimote_t* wm, byte report_type, byte* msg, int len) {
	...
	//bt_send_l2cap( wm->c_source_cid, buf, len+2);//TODO
