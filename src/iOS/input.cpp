...
extern float mfi_analog_x[4]; // Les Bird - MFI controller support
extern float mfi_analog_y[4]; // Les Bird - MFI controller support
...
void osd_analogjoy_read(int player,int *analog_x, int *analog_y)
{
	*analog_x = *analog_y = 0;
	...
	pos_analog_x[player] += (short)(mfi_analog_x[player] * 128.0f); // Les Bird - MFI controller support
	pos_analog_y[player] += (short)(mfi_analog_y[player] * 128.0f); // Les Bird - MFI controller support
